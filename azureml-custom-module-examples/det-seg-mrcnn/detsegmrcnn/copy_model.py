...
def test(model_folder, model_filename, out_model_folder):
    os.makedirs(out_model_folder, exist_ok=True)
    src_path = os.path.join(model_folder, model_filename)
    tgt_path = os.path.join(out_model_folder, model_filename)
