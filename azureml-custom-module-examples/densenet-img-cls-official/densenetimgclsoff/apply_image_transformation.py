...
def entrance(transform_type,
             input_transform_path='/mnt/chjinche/data/out_transform/',
             input_image_path='/mnt/chjinche/data/image_dir_train/',
             output_path='/mnt/chjinche/data/out_transform_train/'):
